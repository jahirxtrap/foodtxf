...
public class ModContent {
    ...
    public static final RegistryObject<Block> RICE_CROP = registerBlock("rice", () -> new RiceCropBlock(BlockBehaviour.Properties.copy(Blocks.WHEAT)), new Item.Properties());
