...
public class ModContent {
    ...
    public static final RegistryObject<Item> BAGUETTE_SWORD = registerItem("baguette_sword", (p) -> new BaguetteItem(p), new Item.Properties());
    ...
    public static final RegistryObject<Item> GLASS_OF_WATER = registerItem("glass_of_water", (p) -> new ContainerFoodItem(2, 1, 1, true, p), new Item.Properties());
    ...
    public static final RegistryObject<Item> GLASS_OF_LAVA = registerItem("glass_of_lava", (p) -> new ContainerFoodItem(2, 1, 2, true, p), new Item.Properties());
    ...
    public static final RegistryObject<Item> SKILLET = registerItem("skillet", (p) -> new BaseSkilletItem(ToolMaterial.IRON, p), new Item.Properties());
