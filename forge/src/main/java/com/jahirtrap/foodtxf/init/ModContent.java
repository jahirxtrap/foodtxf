...
public class ModContent {
    ...
    public static final RegistryObject<Block> RICE_CROP = registerBlock("rice", RiceCropBlock::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.WHEAT), new Item.Properties().compostable(ContextIntProviders.COMPOSTABLE_LOW));
    public static final RegistryObject<Item> RICE_BALL = registerItem("rice_ball", (p) -> new BaseFoodItem(6, 0.5f, p), new Item.Properties().compostable(ContextIntProviders.COMPOSTABLE_MEDIUM_HIGH));
    public static final RegistryObject<Item> DOUGH_BALL = registerItem("dough_ball", (p) -> new BaseFoodItem(2, 0.2f, p), new Item.Properties().compostable(ContextIntProviders.COMPOSTABLE_MEDIUM));
    public static final RegistryObject<Item> TOASTED_BREAD = registerItem("toasted_bread", (p) -> new BaseFoodItem(8, 0.75f, p), new Item.Properties().compostable(ContextIntProviders.COMPOSTABLE_ALWAYS_ADD_ONE));
    public static final RegistryObject<Item> BREAD_SLICE = registerItem("bread_slice", (p) -> new BaseFoodItem(4, 0.5f, p), new Item.Properties().compostable(ContextIntProviders.COMPOSTABLE_LOW_MEDIUM));
    public static final RegistryObject<Item> TOASTED_BREAD_SLICE = registerItem("toasted_bread_slice", (p) -> new BaseFoodItem(6, 0.65f, p), new Item.Properties().compostable(ContextIntProviders.COMPOSTABLE_MEDIUM_HIGH));
    public static final RegistryObject<Item> BAGUETTE = registerItem("baguette", (p) -> new BaseFoodItem(15, 0.6f, 64, p), new Item.Properties().compostable(ContextIntProviders.COMPOSTABLE_ALWAYS_ADD_ONE));
    public static final RegistryObject<Item> BAGUETTE_SWORD = registerItem("baguette_sword", (p) -> new Item(p.sword(ModMaterials.Tool.BREAD, 3f, -2.4f)), new Item.Properties().food(new FoodProperties.Builder().nutrition(15).saturationModifier(0.6f).build(), Consumables.defaultFood().consumeSeconds(64 / 20f).build()).compostable(ContextIntProviders.COMPOSTABLE_ALWAYS_ADD_ONE));
    public static final RegistryObject<Item> COOKED_CARROT = registerItem("cooked_carrot", (p) -> new BaseFoodItem(5, 0.7f, p), new Item.Properties().compostable(ContextIntProviders.COMPOSTABLE_MEDIUM_HIGH));
    public static final RegistryObject<Item> COOKED_BEETROOT = registerItem("cooked_beetroot", (p) -> new BaseFoodItem(5, 0.6f, p), new Item.Properties().compostable(ContextIntProviders.COMPOSTABLE_MEDIUM_HIGH));
    public static final RegistryObject<Item> PUMPKIN_SLICE = registerItem("pumpkin_slice", (p) -> new BaseFoodItem(4, 0.35f, p), new Item.Properties().compostable(ContextIntProviders.COMPOSTABLE_LOW_MEDIUM));
    ...
    public static final RegistryObject<Item> CHEESE = registerItem("cheese", (p) -> new BaseFoodItem(4, 0.75f, p), new Item.Properties().compostable(ContextIntProviders.COMPOSTABLE_MEDIUM));
    public static final RegistryObject<Item> CHEESE_SLICE = registerItem("cheese_slice", (p) -> new BaseFoodItem(2, 0.75f, p), new Item.Properties().compostable(ContextIntProviders.COMPOSTABLE_LOW));
    ...
    public static final RegistryObject<Item> BOX = registerItem("box", Item::new, new Item.Properties().cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_ITEMS_LARGE));
    ...
    public static final RegistryObject<Item> WOODEN_KNIFE = registerItem("wooden_knife", (p) -> new BaseKnifeItem(ToolMaterial.WOOD, p), new Item.Properties().cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_ITEMS_LARGE));
    ...
    public static final RegistryObject<Item> CUTTING_BOARD = registerItem("cutting_board", BaseReusableItem::new, new Item.Properties().cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_ITEMS_LARGE));
    public static final RegistryObject<Item> MIXING_BOWL = registerItem("mixing_bowl", BaseReusableItem::new, new Item.Properties());
    public static final RegistryObject<Item> ROLLING_PIN = registerItem("rolling_pin", RollingPinItem::new, new Item.Properties().cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_ITEMS_SMALL));
