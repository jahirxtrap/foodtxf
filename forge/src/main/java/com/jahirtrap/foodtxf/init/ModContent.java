...
public class ModContent {
    ...
    public static final RegistryObject<Item> THERMOS = registerItem("thermos", () -> new FluidContainerItem(0, new Item.Properties()));
    public static final RegistryObject<Item> GLASS = registerItem("glass", () -> new FluidContainerItem(1, new Item.Properties()));
    public static final RegistryObject<Item> BOX = registerItem("box", () -> new BaseItem(new Item.Properties()));
    ...
    public static final RegistryObject<Item> GLASS_OF_WATER = registerItem("glass_of_water", () -> new ContainerFoodItem(2, 1, 1, true));
    ...
    public static final RegistryObject<Item> GLASS_OF_LAVA = registerItem("glass_of_lava", () -> new ContainerFoodItem(2, 1, 2, true));
    ...
    public static final RegistryObject<Item> SKILLET = registerItem("skillet", () -> new BaseSkilletItem(Tiers.IRON, new Item.Properties()));
    ...
    public static RegistryObject<Block> registerBlock(String name, Supplier<Block> supplier, Item.Properties itemProp) {
        ...
        registerItem(name, () -> new BlockItem(blockReg.get(), itemProp.tab(TAB_FOOD_TXF)));
        return blockReg;
    }
