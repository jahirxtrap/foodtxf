...
public class ModContent {
    ...
    public static final RegistryObject<Item> BAGUETTE_SWORD = registerItem("baguette_sword", () -> new SwordItem(ModTiers.BREAD, new Item.Properties().attributes(SwordItem.createAttributes(ModTiers.BREAD, 3, -2.4F)).food(new FoodProperties(15, FoodConstants.saturationByModifier(15, 0.6f), false, 64 / 20f, List.of()))));
