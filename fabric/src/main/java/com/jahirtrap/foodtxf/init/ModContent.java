...
public class ModContent {
    ...
    public static final Item BAGUETTE_SWORD = registerItem("baguette_sword", new SwordItem(ModTiers.BREAD, new Item.Properties().attributes(SwordItem.createAttributes(ModTiers.BREAD, 3, -2.4F)).food(new FoodProperties(15, FoodConstants.saturationByModifier(15, 0.6f), false, 64 / 20f, List.of()))));
    ...
    public static final Item ZURITE_KNIFE = registerItem("zurite_knife", new BaseKnifeItem(ModTiers.ZURITE, new Item.Properties().fireResistant()));
    public static final Item IRON_SKILLET = registerItem("iron_skillet", new BaseSkilletItem(Tiers.IRON, new Item.Properties()));
    ...
    public static final Item ZURITE_SKILLET = registerItem("zurite_skillet", new BaseSkilletItem(ModTiers.ZURITE, new Item.Properties().fireResistant()));
    public static final Item CUTTING_BOARD = registerItem("cutting_board", new BaseReusableItem(new Item.Properties()));
    public static final Item MIXING_BOWL = registerItem("mixing_bowl", new BaseReusableItem(new Item.Properties()));
    ...
    public static final Item BLENDER = registerItem("blender", new BaseReusableItem(new Item.Properties()));
    public static final Block BLACK_KITCHEN_BLOCK = registerBlock("black_kitchen_block", new BaseKitchenBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLACK).strength(0.8f, 3f).requiresCorrectToolForDrops()), new Item.Properties());
