...
public class ModContent {
    ...
    public static final Block RICE_CROP = registerBlock("rice", new RiceCropBlock(BlockBehaviour.Properties.copy(Blocks.WHEAT)), new Item.Properties());
    ...
    public static final Item THERMOS = registerItem("thermos", new FluidContainerItem(0, new Item.Properties()));
    public static final Item GLASS = registerItem("glass", new FluidContainerItem(1, new Item.Properties()));
    public static final Item BOX = registerItem("box", new BaseItem(new Item.Properties()));
    ...
    private static Block registerBlock(String name, Block block, Item.Properties itemProp) {
        registerItem(name, new BlockItem(block, itemProp.tab(TAB_FOOD_TXF)));
