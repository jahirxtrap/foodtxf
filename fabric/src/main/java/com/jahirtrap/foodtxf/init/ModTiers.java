...
public enum ModTiers implements Tier {
    ...
    STEEL(2, 501, 6.5f, 2f, 14, () -> Ingredient.of(itemTag("c:steel_ingots"))),
    BRONZE(2, 350, 7f, 2f, 16, () -> Ingredient.of(itemTag("c:bronze_ingots"))),
    ENDERITE(4, 4096, 15f, 5f, 17, () -> Ingredient.of(itemTag("c:enderite_ingots")));
