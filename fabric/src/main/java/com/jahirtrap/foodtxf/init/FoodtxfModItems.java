...
public class FoodtxfModItems {
    ...
    public static final Item THERMOS = RegistryObject("thermos", new ThermosItem(new Item.Properties()));
    public static final Item GLASS = RegistryObject("glass", new Item(new Item.Properties()));
    ...
    public static final Item WATER_THERMOS = RegistryObject("water_thermos", new FluidThermosItem(1));
    public static final Item LAVA_THERMOS = RegistryObject("lava_thermos", new FluidThermosItem(2));
    public static final Item MILK_THERMOS = RegistryObject("milk_thermos", new FluidThermosItem(3));
    public static final Item CHOCOMILK_THERMOS = RegistryObject("chocomilk_thermos", new FluidThermosItem());
