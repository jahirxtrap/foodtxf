        ...
        if (accesor instanceof Level level) {
            ...
            if (!level.isClientSide()) {
                level.playSound(null, new BlockPos(x, y, z),
                        Objects.requireNonNull(Registry.SOUND_EVENT.get(new ResourceLocation(sound))), SoundSource.PLAYERS,
                        (float) 0.6, 1);
            } else {
                level.playLocalSound(x, y, z, Objects.requireNonNull(Registry.SOUND_EVENT.get(new ResourceLocation(sound))),
