...
public class FillMilkProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		...
		if (!((world
			...
			if ((entity instanceof Cow || entity instanceof Goat) && !(entity instanceof LivingEntity _livEnt ? _livEnt.isBaby() : false)) {
				if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == FoodtxfModItems.THERMOS
					...
					if (!(sourceentity instanceof Player _plr ? _plr.getAbilities().instabuild : false)) {
						if (sourceentity instanceof LivingEntity _entity) {
							...
							_setstack.setCount(
									(int) (((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)).getCount()
											- 1));
					...
					if (!(sourceentity instanceof Player _plr ? _plr.getAbilities().instabuild : false)) {
						if (sourceentity instanceof LivingEntity _entity) {
							ItemStack _setstack = new ItemStack(FoodtxfModItems.THERMOS.get());
							_setstack.setCount(
									(int) (((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY)).getCount()
											- 1));
