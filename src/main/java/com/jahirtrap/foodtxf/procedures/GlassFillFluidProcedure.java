...
public class GlassFillFluidProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
        ...
        if (entity.level.clip(new ClipContext(entity.getEyePosition(1f), entity.getEyePosition(1f).add(entity.getViewVector(1f).scale(5)),
            ...
            if ((world.getFluidState(new BlockPos(
                ...
                if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == FoodtxfModItems.GLASS
                    ...
                    if (!(entity instanceof Player _plr && _plr.getAbilities().instabuild)) {
                        if (entity instanceof LivingEntity _entity) {
                            ItemStack _setstack = new ItemStack(FoodtxfModItems.GLASS);
                            _setstack.setCount(
                    ...
                    if (entity instanceof Player _player) {
                        ItemStack _setstack = new ItemStack(FoodtxfModItems.GLASS_OF_WATER);
                ...
                } else if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == FoodtxfModItems.GLASS
                        && !((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)
                        .getItem() == FoodtxfModItems.GLASS)) {
                    if (!(entity instanceof Player _plr && _plr.getAbilities().instabuild)) {
                        if (entity instanceof LivingEntity _entity) {
                            ItemStack _setstack = new ItemStack(FoodtxfModItems.GLASS);
                            _setstack.setCount(
                ...
                if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == FoodtxfModItems.GLASS
                    ...
                    if (entity instanceof LivingEntity _entity)
                        _entity.swing(InteractionHand.MAIN_HAND, true);
                    if (entity instanceof Player _player) {
                        ItemStack _setstack = new ItemStack(FoodtxfModItems.GLASS_OF_LAVA);
                        _setstack.setCount(1);
                        ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
                    }
                    if (world instanceof Level _level) {
