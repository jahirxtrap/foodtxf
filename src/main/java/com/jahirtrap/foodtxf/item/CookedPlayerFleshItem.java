...
public class CookedPlayerFleshItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:cooked_player_flesh")
    public static final Item block = null;

    public CookedPlayerFleshItem(FoodtxfModElements instance) {
        super(instance, 2);
    }
    ...
    public static class ItemCustom extends Item {
        public ItemCustom() {
            super(new Item.Properties().tab(FoodTXFItemGroup.tab).stacksTo(64).rarity(Rarity.COMMON)
                    .food((new Food.Builder()).nutrition(8).saturationMod(0.8f)
