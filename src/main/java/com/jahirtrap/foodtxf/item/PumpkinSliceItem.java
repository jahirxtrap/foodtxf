...
public class PumpkinSliceItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:pumpkin_slice")
    public static final Item block = null;

    public PumpkinSliceItem(FoodtxfModElements instance) {
        super(instance, 12);
    }
    ...
    public static class ItemCustom extends Item {
        public ItemCustom() {
            super(new Item.Properties().tab(FoodTXFItemGroup.tab).stacksTo(64).rarity(Rarity.COMMON)
                    .food((new Food.Builder()).nutrition(4).saturationMod(0.35f)
