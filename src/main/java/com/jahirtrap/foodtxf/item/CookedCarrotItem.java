...
public class CookedCarrotItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:cooked_carrot")
    public static final Item block = null;

    public CookedCarrotItem(FoodtxfModElements instance) {
        super(instance, 10);
    }
    ...
    public static class ItemCustom extends Item {
        public ItemCustom() {
            super(new Item.Properties().tab(FoodTXFItemGroup.tab).stacksTo(64).rarity(Rarity.COMMON)
                    .food((new Food.Builder()).nutrition(5).saturationMod(0.7f)
