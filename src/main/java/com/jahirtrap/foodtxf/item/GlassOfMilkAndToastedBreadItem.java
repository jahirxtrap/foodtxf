...
public class GlassOfMilkAndToastedBreadItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:glass_of_milk_and_toasted_bread")
    public static final Item block = null;

    public GlassOfMilkAndToastedBreadItem(FoodtxfModElements instance) {
        super(instance, 47);
    }
    ...
    public static class ItemCustom extends Item {
        public ItemCustom() {
            super(new Item.Properties().tab(FoodTXFItemGroup.tab).stacksTo(64).rarity(Rarity.COMMON)
                    .food((new Food.Builder()).nutrition(12).saturationMod(0.675f)

                            .build()));
            setRegistryName("glass_of_milk_and_toasted_bread");
        }
