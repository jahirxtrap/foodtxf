...
public class GoldenPlayerFleshItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:golden_player_flesh")
    public static final Item block = null;

    public GoldenPlayerFleshItem(FoodtxfModElements instance) {
        super(instance, 15);
    }
        ...
        public ItemCustom() {
            super(new Item.Properties().tab(FoodTXFItemGroup.tab).stacksTo(64).rarity(Rarity.COMMON)
                    .food((new Food.Builder()).nutrition(10).saturationMod(0.8f)
                            ...
                            .meat().build()));
            setRegistryName("golden_player_flesh");
        }
