...
public class LavaThermosItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:lava_thermos")
    public static final Item block = null;

    public LavaThermosItem(FoodtxfModElements instance) {
        super(instance, 36);
    }
