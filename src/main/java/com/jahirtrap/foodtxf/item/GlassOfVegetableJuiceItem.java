...
public class GlassOfVegetableJuiceItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:glass_of_vegetable_juice")
    public static final Item block = null;

    public GlassOfVegetableJuiceItem(FoodtxfModElements instance) {
        super(instance, 40);
    }
    ...
    public static class ItemCustom extends Item {
        public ItemCustom() {
            ...
            setRegistryName("glass_of_vegetable_juice");
        }
