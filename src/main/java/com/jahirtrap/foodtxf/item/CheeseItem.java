...
public class CheeseItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:cheese")
    public static final Item block = null;

    public CheeseItem(FoodtxfModElements instance) {
        super(instance, 22);
    }
    ...
    public static class ItemCustom extends Item {
        public ItemCustom() {
            super(new Item.Properties().tab(FoodTXFItemGroup.tab).stacksTo(64).rarity(Rarity.COMMON)
                    .food((new Food.Builder()).nutrition(4).saturationMod(0.75f)
