...
public class GoldenBreadItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:golden_bread")
    public static final Item block = null;

    public GoldenBreadItem(FoodtxfModElements instance) {
        super(instance, 17);
    }
    ...
    public static class ItemCustom extends Item {
        public ItemCustom() {
            super(new Item.Properties().tab(FoodTXFItemGroup.tab).stacksTo(64).rarity(Rarity.COMMON)
                    .food((new Food.Builder()).nutrition(10).saturationMod(0.76f)
