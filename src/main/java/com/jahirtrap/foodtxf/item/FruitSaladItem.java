...
public class FruitSaladItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:fruit_salad")
    public static final Item block = null;

    public FruitSaladItem(FoodtxfModElements instance) {
        super(instance, 29);
    }
