...
public class GlassOfWaterAndBreadItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:glass_of_water_and_bread")
    public static final Item block = null;

    public GlassOfWaterAndBreadItem(FoodtxfModElements instance) {
        super(instance, 43);
    }
    ...
    public static class ItemCustom extends Item {
        public ItemCustom() {
            super(new Item.Properties().tab(FoodTXFItemGroup.tab).stacksTo(64).rarity(Rarity.COMMON)
                    .food((new Food.Builder()).nutrition(7).saturationMod(0.5f)

                            .build()));
            setRegistryName("glass_of_water_and_bread");
        }
