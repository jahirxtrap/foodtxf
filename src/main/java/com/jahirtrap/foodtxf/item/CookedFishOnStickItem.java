...
public class CookedFishOnStickItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:cooked_fish_on_stick")
    public static final Item block = null;

    public CookedFishOnStickItem(FoodtxfModElements instance) {
        super(instance, 33);
    }
    ...
    public static class ItemCustom extends Item {
        public ItemCustom() {
            super(new Item.Properties().tab(FoodTXFItemGroup.tab).stacksTo(64).rarity(Rarity.COMMON)
                    .food((new Food.Builder()).nutrition(10).saturationMod(0.7f)

                            .build()));
            setRegistryName("cooked_fish_on_stick");
        }
