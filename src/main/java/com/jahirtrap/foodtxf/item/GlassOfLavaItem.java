...
public class GlassOfLavaItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:glass_of_lava")
    public static final Item block = null;

    public GlassOfLavaItem(FoodtxfModElements instance) {
        super(instance, 44);
    }
    ...
    public static class ItemCustom extends Item {
        ...
        public ItemStack finishUsingItem(ItemStack itemstack, World world, LivingEntity entity) {
            ...
            EntityDrinksLavaProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
