...
public class CheeseSandwichItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:cheese_sandwich")
    public static final Item block = null;

    public CheeseSandwichItem(FoodtxfModElements instance) {
        super(instance, 28);
    }
    ...
    public static class ItemCustom extends Item {
        public ItemCustom() {
            super(new Item.Properties().tab(FoodTXFItemGroup.tab).stacksTo(64).rarity(Rarity.COMMON)
                    .food((new Food.Builder()).nutrition(10).saturationMod(0.6f)
