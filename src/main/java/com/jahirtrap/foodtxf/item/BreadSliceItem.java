...
public class BreadSliceItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:bread_slice")
    public static final Item block = null;

    public BreadSliceItem(FoodtxfModElements instance) {
        super(instance, 8);
    }
    ...
    public static class ItemCustom extends Item {
        public ItemCustom() {
            super(new Item.Properties().tab(FoodTXFItemGroup.tab).stacksTo(64).rarity(Rarity.COMMON)
                    .food((new Food.Builder()).nutrition(4).saturationMod(0.5f)
