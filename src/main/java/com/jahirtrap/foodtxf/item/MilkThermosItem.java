...
public class MilkThermosItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:milk_thermos")
    public static final Item block = null;

    public MilkThermosItem(FoodtxfModElements instance) {
        super(instance, 37);
    }
