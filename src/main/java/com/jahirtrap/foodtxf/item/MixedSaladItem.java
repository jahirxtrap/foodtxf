...
public class MixedSaladItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:mixed_salad")
    public static final Item block = null;

    public MixedSaladItem(FoodtxfModElements instance) {
        super(instance, 31);
    }
