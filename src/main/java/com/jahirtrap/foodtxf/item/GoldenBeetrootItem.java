...
public class GoldenBeetrootItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:golden_beetroot")
    public static final Item block = null;

    public GoldenBeetrootItem(FoodtxfModElements instance) {
        super(instance, 20);
    }
