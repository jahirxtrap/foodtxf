...
public class GlassOfMilkAndCookiesItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:glass_of_milk_and_cookies")
    public static final Item block = null;

    public GlassOfMilkAndCookiesItem(FoodtxfModElements instance) {
        super(instance, 46);
    }
