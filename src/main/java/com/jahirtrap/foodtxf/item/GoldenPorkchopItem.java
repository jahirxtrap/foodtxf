...
public class GoldenPorkchopItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:golden_porkchop")
    public static final Item block = null;

    public GoldenPorkchopItem(FoodtxfModElements instance) {
        super(instance, 14);
    }
        ...
        public ItemCustom() {
            super(new Item.Properties().tab(FoodTXFItemGroup.tab).stacksTo(64).rarity(Rarity.COMMON)
                    .food((new Food.Builder()).nutrition(10).saturationMod(0.8f)
                            ...
                            .meat().build()));
            setRegistryName("golden_porkchop");
        }
