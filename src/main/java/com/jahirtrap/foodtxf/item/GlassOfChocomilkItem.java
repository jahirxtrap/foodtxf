...
public class GlassOfChocomilkItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:glass_of_chocomilk")
    public static final Item block = null;

    public GlassOfChocomilkItem(FoodtxfModElements instance) {
        super(instance, 48);
    }
    ...
    public static class ItemCustom extends Item {
        public ItemCustom() {
            ...
            setRegistryName("glass_of_chocomilk");
        }
