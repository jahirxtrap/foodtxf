...
public class CookedPufferfishItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:cooked_pufferfish")
    public static final Item block = null;

    public CookedPufferfishItem(FoodtxfModElements instance) {
        super(instance, 4);
    }
