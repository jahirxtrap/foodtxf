...
public class NetheriteKnifeItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:netherite_knife")
    public static final Item block = null;

    public NetheriteKnifeItem(FoodtxfModElements instance) {
        super(instance, 56);
    }
    ...
    public void initElements() {
        ...
        }, 3, -2f, new Item.Properties().tab(FoodTXFItemGroup.tab).fireResistant()) {
            @Override
