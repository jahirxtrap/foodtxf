...
public class GoldenFishItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:golden_fish")
    public static final Item block = null;

    public GoldenFishItem(FoodtxfModElements instance) {
        super(instance, 16);
    }
    ...
    public static class ItemCustom extends Item {
        public ItemCustom() {
            super(new Item.Properties().tab(FoodTXFItemGroup.tab).stacksTo(64).rarity(Rarity.COMMON)
                    .food((new Food.Builder()).nutrition(8).saturationMod(0.85f)
