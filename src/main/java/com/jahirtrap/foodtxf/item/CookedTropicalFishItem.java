...
public class CookedTropicalFishItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:cooked_tropical_fish")
    public static final Item block = null;

    public CookedTropicalFishItem(FoodtxfModElements instance) {
        super(instance, 5);
    }
    ...
    public static class ItemCustom extends Item {
        public ItemCustom() {
            super(new Item.Properties().tab(FoodTXFItemGroup.tab).stacksTo(64).rarity(Rarity.COMMON)
                    .food((new Food.Builder()).nutrition(6).saturationMod(0.85f)
