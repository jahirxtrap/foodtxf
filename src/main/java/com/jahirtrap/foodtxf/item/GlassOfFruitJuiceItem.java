...
public class GlassOfFruitJuiceItem extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:glass_of_fruit_juice")
    public static final Item block = null;

    public GlassOfFruitJuiceItem(FoodtxfModElements instance) {
        super(instance, 39);
    }
    ...
    public static class ItemCustom extends Item {
        public ItemCustom() {
            ...
            setRegistryName("glass_of_fruit_juice");
        }
