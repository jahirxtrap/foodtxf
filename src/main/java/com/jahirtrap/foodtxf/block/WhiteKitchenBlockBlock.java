...
public class WhiteKitchenBlockBlock extends FoodtxfModElements.ModElement {
    @ObjectHolder("foodtxf:white_kitchen_block")
    public static final Block block = null;

    public WhiteKitchenBlockBlock(FoodtxfModElements instance) {
        super(instance, 75);
    }
