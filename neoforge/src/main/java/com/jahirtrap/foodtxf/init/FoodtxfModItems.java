...
public class FoodtxfModItems {
    ...
    public static final DeferredItem<Item> GLASS = REGISTRY.register("glass", BaseItem::new);
    ...
    public static final DeferredItem<Item> BOX = REGISTRY.register("box", BaseItem::new);
