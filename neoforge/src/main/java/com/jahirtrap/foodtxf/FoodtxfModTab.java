...
public class FoodtxfModTab {
    ...
    public static final Supplier<CreativeModeTab> TAB_FOOD_TXF = TAB_REGISTER.register("tab_foodtxf", () -> CreativeModeTab.builder()
            ...
            .displayItems((features, event) -> {
                ...
                event.accept(FoodtxfModItems.BLACK_KITCHEN_BLOCK);
                event.accept(FoodtxfModItems.WHITE_KITCHEN_BLOCK);
